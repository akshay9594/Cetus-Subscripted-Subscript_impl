...
int main(int argc, char * argv[])
{
	...
	print_results("UA", Class, 8, 0, 0, niter, tmax, mflops, "    coll. point advanced", verified, "3.3.1", "27 Jan 2023", "gcc", "$(CC)", "-lm", "-I../common", "-g -Wall -O3 -fopenmp -mcmodel=large", "-O3 -fopenmp -mcmodel=large", "(none)");
	timeron=false;

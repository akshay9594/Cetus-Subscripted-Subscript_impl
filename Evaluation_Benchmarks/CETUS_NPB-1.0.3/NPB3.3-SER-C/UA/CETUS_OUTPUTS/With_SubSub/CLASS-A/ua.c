...
/* commonfacein */
int idmo[2400][6][2][2][5][5];
int idel[2400][6][5][5];
int sje[2400][6][2][2];
int sje_new[2400][6][2][2];
int ijel[2400][6][2];
int ijel_new[2400][6][2];
int cbc[2400][6];
int cbc_new[2400][6];
...
int treenew[2400];
int mt_to_id[2400];
int mt_to_id_old[2400];
int id_to_mt[2400];
int newc[2400];
int newi[2400];
int newe[2400];
int ref_front_id[2400];
int ich[2400];
int size_e[2400];
int front[2400];
int action[2400];
...
/* commonvlg */
logical ifpcmor[(8*2400)];
/* logical arrays associated with edge */
/* commonedgelg */
logical eassign[2400][12];
logical ncon_edge[2400][12];
logical if_1_edge[2400][12];
/* logical arrays associated with elements */
/* commonfacelg */
logical skip[2400];
logical ifcoa[2400];
logical ifcoa_id[2400];
/* logical arrays associated with element faces */
/* commonmasonl */
logical fassign[2400][6];
logical edgevis[2400][6][4];
/* small arrays */
/* commontransr */
double qbnew[2][5][(5-2)];
double bqnew[2][(5-2)][(5-2)];
/* commonpcr */
double pcmor_nc1[6][2][2][5][5];
double pcmor_nc2[6][2][2][5][5];
double pcmor_nc0[6][2][2][5][5];
double pcmor_c[6][5][5];
double tcpre[5][5];
double pcmor_cor[6][8];
...
double yc[2400][8];
double zc[2400][8];
double xc_new[2400][8];
double yc_new[2400][8];
double zc_new[2400][8];
/* drdx, dx/dr  and Jacobian */
/* commongiso */
double jacm1_s[6][5][5][5];
double rxm1_s[6][5][5][5];
double xrm1_s[6][5][5][5];
...
double g4m1_s[6][5][5][5];
double g5m1_s[6][5][5][5];
double g6m1_s[6][5][5][5];
...
int main(int argc, char * argv[])
{
	...
	print_results("UA", Class, 6, 0, 0, niter, tmax, mflops, "    coll. point advanced", verified, "3.3.1", "26 Jan 2023", "gcc", "$(CC)", "-lm", "-I../common", "-g -Wall -O3 -fopenmp -mcmodel=large", "-O3 -fopenmp -mcmodel=large", "(none)");
	timeron=false;

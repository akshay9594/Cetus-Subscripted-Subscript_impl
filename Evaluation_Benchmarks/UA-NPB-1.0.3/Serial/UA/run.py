...
test_result = subprocess.call([Cetus_path, " -subsub_analysis -normalize-loops -reduction=1 -alias=3 " + test_files],stdout=subprocess.DEVNULL,stderr=subprocess.STDOUT)

...
/* ========================================================================== */
/* === t_cholmod_dense_to_sparse_scale======================================= */
/* ========================================================================== */

/*
    Routine to convert the input dense matrix to sparse and scale it using a 
    Scale factor.
*/

static cholmod_sparse *TEMPLATE (cholmod_dense_to_sparse_scale)
(
    /* ---- input ---- */
...
)
{
    ...
    //Subscripted subscript loop that performs the core computation
    for (j = 0 ; j < ncol ; j++)
	{
	    t = s[j] ;
